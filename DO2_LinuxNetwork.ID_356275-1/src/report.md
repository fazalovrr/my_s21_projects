...
- `ipcalc` - ipcalc — консольная утилита для расчёта параметров IPv4-сети (сетевой и broadcast-адрес, маска, диапазон хостов) по заданному адресу/префиксу.
...
- sender: 944 Mbits/sec
- receiver: 985 Mbits/sec
...
![5_3](images/5_r1_1.png)

- машина r2

![5_3](images/5_r2_1.png)
...
![5_4](images/5_11_2.png)

- машина ws21

![5_4](images/5_21_2.png)
...
![5_6](images/5_r1_2.png)

- машина r2

![5_6](images/5_r2_2.png)
...
`ssh -L 8080:ws22:80 gianname@10.20.0.20`
...
Чтобы это сделать нужно воспользоваться командой `ssh -R 8080:localhost:80 gianname@10.20.0.20 `, которая позволяет соедениться со сторонним хостом.

![8_6](images/8_6.png)

Для проверки, сработало ли подключение в обоих предыдущих пунктах, перейдем во второй терминал (клавишами Alt + F2) и выполним команду `telnet 127.0.0.1 8080`

![8_7](images/8_7.png)

Подключение есть.

#### Сохраним дампы машин
